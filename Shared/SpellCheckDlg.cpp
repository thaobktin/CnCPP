...
void CSpellCheckDlg::InitDialog(ISpellCheck* pSpellCheck, const CString& sText)
{
	...
	AddRCControl(_T("LTEXT"), _T(""), _T("Download More Dictionaries"), WS_TABSTOP,0, 66,21,182,8,IDC_SCD_URL);
	AddRCControl(_T("LTEXT"), _T(""), _T("C&hecking Text:"), 0,0, 7,30,149,8, IDC_SCD_CHECKINGLABEL);
	AddRCControl(_T("CONTROL"), _T("RICHEDIT"), _T(""),ES_MULTILINE | ES_AUTOVSCROLL | ES_NOHIDESEL | ES_READONLY | WS_VSCROLL | WS_TABSTOP | WS_DISABLED,0, 7,40,242,68,IDC_SCD_TEXT);
