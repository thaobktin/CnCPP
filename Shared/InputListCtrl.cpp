...
//	IMAGEINFO iInfo;
	...
	if (lpDrawItemStruct->itemAction & (ODA_DRAWENTIRE | ODA_SELECT))
	{
		...
		while (bRes)
		{
			...
			BOOL bSel = (bSelected /*&& nItem == GetCurSel()*/ && nCol == m_nCurCol);
			...
			DrawButton(pDC, nItem, nCol, rButton);
...
BOOL CInputListCtrl::DrawButton(CDC* pDC, int nRow, int nCol, CRect& rButton)
{
