...
public:
	...
	int AddImages(const CUIntArray& aCmdIDs, const CString& sImagePath, int nCx, COLORREF crMask = CLR_NONE);
...
protected:
	...
	int AddImages(const CUIntArray& aCmdIDs, CBitmap& bm, CBitmap& bmDis, int nCx, COLORREF crMask = CLR_NONE);
