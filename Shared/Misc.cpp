...
CString& Misc::Trim(CString& sText)
{
	sText.TrimLeft();
	sText.TrimRight();
...
int Misc::Split(const CString& sText, TCHAR cDelim, CStringArray& aValues, BOOL bAllowEmpty)
{
	return Split(sText, aValues, bAllowEmpty, CString(cDelim));
}
