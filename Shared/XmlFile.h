...
{
public:
	CXmlItem(CXmlItem* pParent = NULL, const CString& sName = _T(""), const CString& sValue = _T(""), XI_TYPE nType = XIT_ELEMENT);
	...
	const CXmlItem* GetItem(const CString& sItemName, const CString& sSubItemName = _T("")) const;
	CXmlItem* GetItem(const CString& sItemName, const CString& sSubItemName = _T(""));
	...
	BOOL HasItem(const CString& sItemName, const CString& sSubItemName = _T("")) const;
	...
	CString GetItemValue(const CString& sItemName, const CString& sSubItemName = _T("")) const;
	int GetItemValueI(const CString& sItemName, const CString& sSubItemName = _T("")) const;
	double GetItemValueF(const CString& sItemName, const CString& sSubItemName = _T("")) const;

	// returns child count
	int GetItemCount() const;

	// returns the number of subitems having this name ie inc. siblings
	int GetItemCount(const CString& sItemName, const CString& sSubItemName = _T("")) const;

    // returns the new item
	CXmlItem* AddItem(const CString& sName, const CString& sValue = _T(""), XI_TYPE nType = XIT_ATTRIB);
	...
	BOOL DeleteItem(const CString& sItemName, const CString& sSubItemName = _T("")); // must be a direct descendent
	void DeleteAllItems();
...
protected:
	...
	const CXmlItem* GetItemEx(const CString& sItemName, const CString& sSubItemName = _T("")) const;
...
{
public:
	CXmlFile(const CString& sRootItemName = _T(""));
	virtual ~CXmlFile();

	BOOL Load(const CString& sFilePath, const CString& sRootItemName = _T(""), IXmlParse* pCallback = NULL);
	BOOL Save(const CString& sFilePath, SFE_SAVEAS nSaveAs = SFE_ASCOMPILED);

	BOOL LoadContent(const CString& sContent, const CString& sRootItemName = _T(""));
	...
	BOOL Transform(const CString& sTransformPath, CString& sOutput, const CString& sEncoding = _T("")) const;
	BOOL TransformToFile(const CString& sTransformPath, const CString& sOutputPath, const CString& sEncoding = _T("")) const;
	...
	BOOL DeleteItem(const CString& sItemName, const CString& sSubItemName = _T("")); 
	...
	void SetXmlHeader(const CString& sHeader);
...
protected:
	...
	BOOL ParseRootItem(const CString& sRootItemName, CXmlDocumentWrapper* pDoc);
