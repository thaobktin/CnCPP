	  ...
	  m_pPrefs(NULL)
{
    ...
    AddRCControl(_T("LTEXT"), _T(""), _T("Files of &type:"), 0, 0,0,164,72,8,IDC_FILETYPESLABEL);
    ...
    AddRCControl(_T("LTEXT"), _T(""), _T("Current Folder:"), 0, 0,0,7,54,8,IDC_CURFOLDERLABEL);
...
void CRemoteFileDialog::InitFilterArray(LPCTSTR szFilters)
{
	...
	if (!m_aFilters.GetSize())
		m_aFilters.Add(FILEFILTER(_T("All Files (*.*)"), _T("")));
}
