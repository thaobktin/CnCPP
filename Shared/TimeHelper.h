...
public:
	...
	static CString FormatISOTime(const COleDateTime& dtTime, BOOL bIncSeconds = FALSE);
	static CString FormatISOTime(int nHour, int nMin, int nSec = 0, BOOL bIncSeconds = FALSE);
	static CString Format24HourTime(const COleDateTime& dtTime, BOOL bIncSeconds = FALSE);
