...
/*	static void InitScrollInfo(SCROLLINFO& si);
	BOOL HasScrollInfoChanged() const;
	void UpdateScrollInfo();
	void GetScrollInfo(SCROLLINFO& siVert) const;
	int CalcVertScrollOffset(SCROLLINFO& siFrom, SCROLLINFO& siTo);
	void ClearScrollInfo();
	BOOL IsScrollInfoSet() const;
*/
};
