...
CRect CRuntimeDlg::GetCtrlRect(UINT nCtrlID)
{
...
void CRuntimeDlg::ExcludeControls(CDC* pDC, UINT nCtrlIDFrom, UINT nCtrlIDTo, BOOL bIgnoreCorners)
{
	CDialogHelper::ExcludeControls(this, pDC, nCtrlIDFrom, nCtrlIDTo, bIgnoreCorners);
}
