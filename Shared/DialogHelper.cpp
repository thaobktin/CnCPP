...
BOOL CDialogHelper::SetComboReadOnly(CComboBox& combo, BOOL bReadOnly)
{
	...
	CRect rect = CDialogHelper::GetCtrlRect(pParent, &combo);
	...
	// switch combo type and recreate
	if (bReadOnly)
	{
...
CString CDialogHelper::GetControlText(const CWnd* pWnd)
{
	CString sText;
