...
public:
	...
	BOOL GetDisplayAllocToColumn() const { return m_bDisplayAllocToColumn; }
...
public:
	...
	BOOL GetDisplayAllocToColumn() const { return m_page.GetDisplayAllocToColumn(); }
