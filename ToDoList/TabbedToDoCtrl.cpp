...
LRESULT CTabbedToDoCtrl::OnUIExtModifySelectedTask(WPARAM wParam, LPARAM lParam)
{
	...
	try
	{
		...
		case TDCA_DONEDATE:
			return SetSelectedTaskDate(TDCD_DONE, *((double*)lParam));

		case TDCA_DUEDATE:
			return SetSelectedTaskDate(TDCD_DUE, *((double*)lParam));

		case TDCA_STARTDATE:
			return SetSelectedTaskDate(TDCD_START, *((double*)lParam));
...
void CTabbedToDoCtrl::UpdateListColumnWidths(BOOL bCheckListVisibility)
{
	...
	for (int nCol = 0; nCol < nNumCol; nCol++)
	{
		...
		if (IsColumnShowing(nColID))
		{
			...
			case TDCC_CATEGORY:
				{
					...
					sLongest = m_find.GetLongestCategory(sEdit, FALSE);
				}
				break;
			...
			case TDCC_TAGS:
				{
					...
					sLongest = m_find.GetLongestTag(sEdit, FALSE);
				}
				break;
			...
			case TDCC_ALLOCTO:
				{
					...
					sLongest = m_find.GetLongestAllocTo(sEdit, FALSE);
				}
				break;
			...
			BOOL bListColWidened = !(pLVData->bMultiSort || pLVData->sort.nBy1 == TDCC_NONE) && pLVData->sort.nBy1 == nColID;
