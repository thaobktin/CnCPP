...
public:
	...
	BOOL GetCategoryListIsReadonly() const { return m_bCatListReadonly; }
	BOOL GetStatusListIsReadonly() const { return m_bStatusListReadonly; }
	BOOL GetAllocToListIsReadonly() const { return m_bAllocToListReadonly; }
	BOOL GetAllocByListIsReadonly() const { return m_bAllocByListReadonly; }
