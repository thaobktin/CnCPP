...
public:
	...
	CString GetLongestCategory(const CString& sExtra, BOOL bVisibleOnly = TRUE) const;
	CString GetLongestTag(const CString& sExtra, BOOL bVisibleOnly = TRUE) const;
	CString GetLongestAllocTo(const CString& sExtra, BOOL bVisibleOnly = TRUE) const;
	...
	CString GetLongestCost(BOOL bVisibleOnly = TRUE) const;
...
protected:
	...
	CString GetLongerString(const CString& str1, const CString& str2) const;
};
