...
public:
	...
	TODOITEM* NewTask(const TODOITEM* pTDIRef = NULL, DWORD dwParentTaskID = 0, const CTDCAttributeArray* pParentAttribs = NULL) const;
...
protected:
	...
	double CalcTimeEstimate(const TODOITEM* pTDI, const TODOSTRUCTURE* pTDS, int nUnits, BOOL bAdjustByPercent) const;
