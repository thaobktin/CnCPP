...
public:
	...
	BOOL PasteTasks(TDC_PASTE nWhere, BOOL bAsRef = FALSE);
	BOOL CanPaste() const;
...
protected:
	...
	int CalcMaxDateColWidth(TDC_DATE nDate, CDC* pDC, BOOL bWantTime);
	...
	virtual void GetTaskTextColors(const TODOITEM* pTDI, const TODOSTRUCTURE* pTDS, COLORREF& crText, COLORREF& crBack) const;
	...
	static int SortTasks(LPARAM lParam1, LPARAM lParam2, TDC_COLUMN nSortBy, BOOL bAscending, 
						...
						/*const CToDoCtrlData* pData,*/ const CToDoCtrl* pTDC,
