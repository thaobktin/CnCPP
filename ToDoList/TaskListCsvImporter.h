...
protected:
	BOOL ImportTask(ITaskList12* pTasks, const CString& sLine) const;
	...
	void AddAttributeToTask(ITaskList12* pTasks, HTASKITEM hTask, TDC_ATTRIBUTE nAttrib, const CStringArray& aValues) const;
	void AddCustomAttributesToTask(ITaskList12* pTasks, HTASKITEM hTask, const CStringArray& aValues) const;
