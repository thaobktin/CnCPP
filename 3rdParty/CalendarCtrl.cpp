...
CCalendarCtrl::CCalendarCtrl() : m_nVisibleWeeks(6), m_bShowWeekends(TRUE)
{
	LOGFONT lf;
	::GetObject((HFONT)GetStockObject(DEFAULT_GUI_FONT),sizeof(lf),&lf);
	memcpy(lf.lfFaceName, _T("Arial"), 5);
	lf.lfHeight = 13;
...
void CCalendarCtrl::DrawGrid(CDC* pDC)
{
	...
	for(int i=1; i<CALENDAR_NUM_COLUMNS; i++)
	{
...
COLORREF CCalendarCtrl::GetFadedThemeColour(unsigned char percent)
{	
